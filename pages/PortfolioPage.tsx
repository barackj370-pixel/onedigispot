        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 md:p-12">
          ...
          <div className="prose prose-lg text-slate-600 max-w-none">
            ...
            <div className="mt-12 pt-8 border-t border-slate-100">
              ...
              <a href="/#contact" className="inline-block bg-indigo-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-indigo-700 transition-all shadow-md hover:shadow-lg no-underline">
                Start Your Project
              </a>
            </div>
          </div>
