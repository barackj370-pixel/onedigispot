      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href={isHome ? "#projects" : "/#projects"} className="text-slate-600 hover:text-indigo-600 font-medium transition-colors">Projects</a>
            <a href={isHome ? "#innovation-lab" : "/#innovation-lab"} className="text-slate-600 hover:text-indigo-600 font-medium transition-colors">Innovation Lab</a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-lg border-t border-slate-100 py-4 px-4 flex flex-col space-y-4">
            ...
            <a onClick={() => setMobileMenuOpen(false)} href={isHome ? "#projects" : "/#projects"} className="block text-slate-600 hover:text-indigo-600 font-medium transition-colors p-2">Projects</a>
            <a onClick={() => setMobileMenuOpen(false)} href={isHome ? "#innovation-lab" : "/#innovation-lab"} className="block text-slate-600 hover:text-indigo-600 font-medium transition-colors p-2">Innovation Lab</a>
